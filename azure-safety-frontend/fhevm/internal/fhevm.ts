...
export const createFhevmInstance = async (parameters: {
  ...
  const relayerSDK = window as unknown as FhevmWindowType;

  const aclAddress = relayerSDK.relayerSDK.SepoliaConfig.aclContractAddress;
  ...
  const config: FhevmInstanceConfig = {
    ...relayerSDK.relayerSDK.SepoliaConfig,
  ...
  const instance = await relayerSDK.relayerSDK.createInstance(config);
